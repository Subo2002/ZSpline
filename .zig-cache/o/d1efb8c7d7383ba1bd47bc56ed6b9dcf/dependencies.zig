pub const packages = struct {
    pub const @"ZSMath-0.0.0-xSatLu2LAACdqq1kl-I1gWWwgGTEXZ0NVOQDBxYd9o7H" = struct {
        pub const build_root = "C:\\Users\\suboc\\AppData\\Local\\zig\\p\\ZSMath-0.0.0-xSatLu2LAACdqq1kl-I1gWWwgGTEXZ0NVOQDBxYd9o7H";
        pub const build_zig = @import("ZSMath-0.0.0-xSatLu2LAACdqq1kl-I1gWWwgGTEXZ0NVOQDBxYd9o7H");
...
pub const root_deps: []const struct { []const u8, []const u8 } = &.{
    ...
    .{ "ZSMath", "ZSMath-0.0.0-xSatLu2LAACdqq1kl-I1gWWwgGTEXZ0NVOQDBxYd9o7H" },
};
