pub const packages = struct {
    pub const @"ZSMath-0.0.0-xSatLoVhAABo9xzBk0MNBM-vMG-y9P6LLfpPOyB4Zkpp" = struct {
        pub const build_root = "C:\\Users\\suboc\\AppData\\Local\\zig\\p\\ZSMath-0.0.0-xSatLoVhAABo9xzBk0MNBM-vMG-y9P6LLfpPOyB4Zkpp";
        pub const build_zig = @import("ZSMath-0.0.0-xSatLoVhAABo9xzBk0MNBM-vMG-y9P6LLfpPOyB4Zkpp");
...
pub const root_deps: []const struct { []const u8, []const u8 } = &.{
    ...
    .{ "ZSMath", "ZSMath-0.0.0-xSatLoVhAABo9xzBk0MNBM-vMG-y9P6LLfpPOyB4Zkpp" },
};
